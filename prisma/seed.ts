...
async function main() {
  ...
  const pasta = await prisma.recipe.create({
    data: {
      ...
      directions: [
        ...
        'Toss pasta with the oil, adding reserved pasta water if needed for consistency.',
        'Add parsley, salt, and pepper. Toss again and serve with Parmesan.',
      ],
      previewUrl: '',
      sourceKind: 'manual',
  ...
  const chickenSoup = await prisma.recipe.create({
    data: {
      ...
      directions: [
        'In a large pot, add chicken, broth, carrots, celery, onion, garlic, and bay leaves.',
        'Bring to a boil, then reduce heat and simmer for 30 minutes.',
        'Remove chicken pieces and shred the meat, discarding bones and skin.',
        'Return shredded chicken to the pot.',
        'Add egg noodles and cook for 8-10 minutes until tender.',
        'Remove bay leaves, add parsley, and season with salt and pepper.',
      ],
      previewUrl: '',
      sourceKind: 'manual',
